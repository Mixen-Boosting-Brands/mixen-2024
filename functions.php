...
if (function_exists("add_theme_support")) {
    ...
    add_theme_support("post-thumbnails", ["post", "page", "proyectos"]);
...
function load_more_posts()
{
    ...
    if ($query->have_posts()):
        while ($query->have_posts()):
            $query->the_post(); ?>
        <div class="col-12">
            <div class="thumb" style="background: url('<?php the_field(
                "thumbnail_banner_principal",
            ); ?>') no-repeat;">
